...
public class Imobiliaria {
    ...
    public Imobiliaria(String nome, String endereco, ArrayList<Aluguel> alugueis, ArrayList<Venda> vendas, ArrayList<Imovel> imoveis, ArrayList<Usuario> clientes, ArrayList<Usuario> corretores, ArrayList<Seguro> seguros, Configuracao configuracoes) {
        this.nome = nome;
